export declare const SEARCH_MODES: readonly ["hybrid", "lexical", "symbols", "semantic"];
export type SearchMode = (typeof SEARCH_MODES)[number];
export type SearchErrorCode = "INVALID_INPUT" | "SCRIPT_NOT_FOUND" | "SPAWN_FAILED" | "PROCESS_FAILED" | "INVALID_OUTPUT" | "OUTPUT_LIMIT" | "TIMED_OUT" | "ABORTED" | "HIT_CALLBACK_FAILED";
export declare class SemanticSearchError extends Error {
...
export type SemanticSearchEvent = {
    ...
    type: "search.hit_callback_failed";
    message: string;
    at: number;
} | {
...
export interface GenericSemanticSearchTool {
    ...
    execute(toolCallId: string, input: SemanticSearchInput | Record<string, unknown>, signal?: AbortSignal): Promise<SemanticSearchToolResult>;
}
export interface SemanticSearchRuntime {
    readonly tool: GenericSemanticSearchTool;
    search(input: SemanticSearchInput | Record<string, unknown>, context?: SemanticSearchExecutionContext): Promise<SemanticSearchResponse>;
}
